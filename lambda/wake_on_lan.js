...
var dgram  = require('dgram'), Buffer = require('buffer').Buffer;

var allocBuffer = Buffer.alloc ?   function allocBuffer(s) { return Buffer.alloc(s) } :  function allocBuffer(s) { return new Buffer(s) }

var mac_bytes = 6;

exports.createMagicPacket = function(mac) {
  var mac_buffer = allocBuffer(mac_bytes), i;
  ...
  var num_macs = 16, buffer   = allocBuffer((1 + num_macs) * mac_bytes);
  for (i = 0; i < mac_bytes; ++i) {
    buffer[i] = 0xff;
  }
...
exports.wake = function(mac, opts, callback) {
  ...
  var address     = opts['address']     || '192.168.0.255'
